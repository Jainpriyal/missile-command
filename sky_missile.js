...
//   		console.log("********** src_0: "+ src[0]);
  ...
  // 		console.log("translation:" + translation);
   		...
   		if(src[0]==dest[0] && src[1]==dest[1])
   		{
   			...
   			setTimeout(function(){self.animate_missile(src, dest,add_x,add_y);}, 150);
   		}
   }
