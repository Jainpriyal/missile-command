...
function loadTriangleTexture(textureLocation, triangleSet)
{
    ...
    if(textureLocation!=false)
    {
        ...
        triangleTexture[triangleSet].image.src = "https://jainpriyal.github.io/textures/city1.jpg";
    }
    else
    {
...
function loadModels() {
   ...
   // inputTriangles = getJSONFile(INPUT_TRIANGLES_URL,"triangles"); // read in the triangle data
    ...
    [
  {
    "material": {"ambient": [1,1,1], "diffuse": [0.6,0.6,0.4], "specular": [0.3,0.3,0.3], "n":17, "alpha": 1, "texture": "tree.png"}, 
    "vertices": [[-8, -0.8, 0.65],[-8, 0.8, 0.65],[2,0.8, 0.65],[2,-0.8, 0.65]],
    ...
    try {
        if (inputTriangles == String.null)
            ...
            inputEllipsoids = [];//sgetJSONFile(INPUT_ELLIPSOIDS_URL,"ellipsoids"); // read in the ellipsoids
